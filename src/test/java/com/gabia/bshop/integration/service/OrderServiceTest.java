...
class OrderServiceTest extends IntegrationTest {
	...
	@DisplayName("주문을 한 회원이 주문목록 조회를 수행하면 주문내역들이 조회되어야한다.")
	@Test
	void findOrdersPaginationTest() {
		//given
	...
	@DisplayName("존재하지 않는 회원이 주문목록 조회를 요청하면 오류가 발생해야한다.")
	@Test
	void findOrdersPaginationException() {
		//given
	...
	@Test
	void findOrdersPaginationDeleted() {
		//given
		LocalDateTime now = LocalDateTime.now();
		Member member1 = Member.builder()
			.name("1_test_name")
