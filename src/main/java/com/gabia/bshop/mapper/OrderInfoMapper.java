...
import com.gabia.bshop.dto.response.OrdersInfoPageResponse.OrderInfo;
...
public interface OrderInfoMapper {
    ...
    default OrdersInfoPageResponse orderInfoRelatedEntitiesToOrderInfoPageResponse(final List<Orders> orders, final List<OrderItem> orderItems, final List<ItemImage> itemImagesWithItem) {
        ...
        return new OrdersInfoPageResponse(orders.size(),
