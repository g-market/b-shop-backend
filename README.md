...
```
cd existing_repo
git remote add origin http://mentoring-gitlab.gabia.com/mentee/mentee_2023.01/team/gabia_b_shop.git
git branch -M main
...
- [ ] [Set up project integrations](http://mentoring-gitlab.gabia.com/mentee/mentee_2023.01/team/gabia_b_shop/-/settings/integrations)
